...
- **Final dataset**: ~80,000 clean records ready for modeling
...
- Why? Avoids artificial bias (prevents model from thinking "diesel > electric" just because of numbering)
